...
end_yr=2015
nmref=adN${nnum}_incr_Mmin${mag_min_pr}_${start_yr}_${end_yr}_neff
...
echo "Catalog_Gaps=0" >> param_smoothing.txt
...
echo "Correct_Area_for_Latitude=1" >> param_smoothing.txt
...
mv pl_agrid.ps pl_agrid_M0_fm_M${mag_min_pr}_adRN${nnum}_incr.ps
#rm t.tmp
